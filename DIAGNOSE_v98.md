...
| **→ v99** | applyRevSrc/applyDelSrc sind No-Ops; audioTick ist alleiniger Schreiber aller vier Effekt-Eingangs-Gains (Music-Seite base, Stör-Seite × xm). | | | erledigt |
...
| **→ v99** | origGate.gain × xm direkt in audioTick — Original im Extrakt absolut stumm, unabhängig von Dry/Wet. | | | erledigt |
...
| **→ v99** | grainDryOut.gain × xm in audioTick + Grain-Spawner: STOER pausiert im Extrakt, ALLES → MUSIK. Original-Körner damit doppelt stumm. | | | erledigt |
